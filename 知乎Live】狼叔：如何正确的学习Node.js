...
Explore
 @YUYUEy Sign out
0
0 312 YUYUEy/How-to-learn-node-correctly
...
[全文]如何正确的学习Node.js https://i5ting.github.io/How-to-learn…
 ...
 0 releases
 8 contributors
 JavaScript 99.9%	 Shell 0.1%
 Pull request   Compare This branch is even with i5ting:master.
@i5ting
i5ting Merge pull request #11 from ntnyq/patch-1  …
Latest commit e3333c4  on 8 Apr
media	add preview for doc site	6 months ago
.gitattributes	fix linguist-language=Node	6 months ago
.gitignore	add preview for doc site	6 months ago
README.md	Merge pull request #11 from ntnyq/patch-1	5 months ago
generate.sh	add doc for git pages deploy	6 months ago
gulpfile.js	add doc for git pages deploy	6 months ago
index.html	fix typo	6 months ago
package.json	add doc for git pages deploy	6 months ago
 README.md
...
熟悉主流移动浏览器的技术特点，有移动端H5项目经验者优先;
有移动端WebGL开发经验者优先;
学习能力强、应变能力强，优秀的沟通能力和协调能力，执行能力强，具备较强的团队合作精神。
蚂蚁金服
岗位要求：
